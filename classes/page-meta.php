...
class PageMeta
{
    ...
    public function descriptionFor(string $page): string
    {
        return match ($page) {
            ...
            'update-pass' => 'Set a new password using a secure Pixelwar reset link.',
            ...
            'review-pending' => 'Your Pixelwar student details are being reviewed before access is unlocked.',
            'review-rejected' => 'Your Pixelwar student details could not be approved yet.',
            ...
            'leaderboards' => 'Pixelwar player leaderboard ranked by progress points.',
            'ranks' => 'Pixelwar rank ladder and minimum point requirements.',
            'room' => 'Pixelwar room lobby with challenge details and joined players.',
            'matching' => 'Pixelwar versus matchmaking screen with live challenge selection visuals.',
