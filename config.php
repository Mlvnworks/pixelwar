...
if (!defined('SUPABASE_STORAGE_COR_FILE_FOLDER')) {
    define('SUPABASE_STORAGE_COR_FILE_FOLDER', Env::get(
        'SUPABASE_STORAGE_COR_FILE_FOLDER',
        Env::get('SUPABASE_STORAGE_COR_PICTURE_FOLDER', 'cor')
    ));
}
...
if (!defined('SUPABASE_STORAGE_CODE_SOLUTION_FOLDER')) {
    define('SUPABASE_STORAGE_CODE_SOLUTION_FOLDER', Env::get('SUPABASE_STORAGE_CODE_SOLUTION_FOLDER', 'code solution'));
}
