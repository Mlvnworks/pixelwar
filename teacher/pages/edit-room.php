...
$strictModeValue = (int) ($roomOld['mode'] ?? ($editingRoom['mode'] ?? 0));
$roomPointsValue = (string) ($roomOld['room_points'] ?? ($editingRoom['room_points'] ?? ''));
?>
                    ...
                    <article class="teacher-panel rounded-[26px] border-4 border-arcade-ink bg-arcade-panel p-4 shadow-[7px_7px_0_#26190f] md:p-5">
                        ...
                        <div class="mt-5 grid gap-4">
                            ...
                            <div class="grid gap-4 sm:grid-cols-2">
                                ...
                                <label class="create-room-field sm:col-span-2" data-room-points-field <?= $strictModeValue === 3 ? '' : 'hidden' ?>>
...
<div class="preview-canvas">${htmlText}</div>
                        ...
                        previewFrame.onload = () => {
                            disablePreviewLinks(previewFrame);
